...
const FOOTBALLER_CARDS = [
  ...
  {id:'suarez',name:'Luis Suárez',emoji:'🇺🇾',nation:'Uruguay',rarity:'silver',type:'player',stats:{goals:508,trophies:25,era:'2003-'},bio:'One of the most prolific and controversial strikers of his generation.',
   clues:[{cat:'Nationality',text:'I am from Salto, Uruguay and one of the greatest strikers in South American history.'},{cat:'PL season',text:'I scored 31 Premier League goals in a single season for Liverpool in 2013-14.'},{cat:'Controversy',text:'I was banned multiple times for biting opponents during matches.'},{cat:'World Cup',text:'I was banned for biting Chiellini at the 2014 World Cup — Uruguay were eliminated.'},{cat:'Barcelona',text:'I formed the deadly "MSN" trio at Barcelona with Messi and Neymar.'}],
...
const RANKED_POOL = [
  ...
  {q:"Which club won the first-ever Premier League title in 1992-93?",opts:["Arsenal","Manchester United","Liverpool","Blackburn Rovers"],ans:1,diff:'very_hard',fact:"Manchester United won the inaugural Premier League season under Sir Alex Ferguson."},
  // ─── IMPOSSIBLE ───
  ...
  {q:"Who is the only player to have played in World Cup finals for two different countries?",opts:["Robert Prosinečki","Josip Weber","Luis Monti","Dejan Savićević"],ans:2,diff:'impossible',fact:"Luis Monti played in the 1930 World Cup final for Argentina and the 1934 final for Italy."},
  // ─── LEGEND ───
  {q:"Which player holds the record for most UEFA Cup / Europa League goals all-time?",opts:["Henrik Larsson","Radamel Falcao","Jürgen Klinsmann","Aritz Aduriz"],ans:1,diff:'legend',fact:"Radamel Falcao scored 17 Europa League goals in a single campaign (2011-12) — the single-season record."},
  ...
  {q:"Which two players shared the 2000 FIFA Player of the Century award?",opts:["Zidane & Ronaldo","Ronaldo & Maldini","Pelé & Maradona","Cruyff & Beckenbauer"],ans:2,diff:'legend',fact:"FIFA named both Pelé and Maradona co-winners of the FIFA Player of the Century award in 2000 after a fan vote."},
  ...
  {q:"In what minute did Liverpool's UCL final comeback begin when they were 3-0 down to AC Milan?",opts:["40th","42nd","54th","60th"],ans:2,diff:'legend',fact:"Steven Gerrard headed home in the 54th minute to spark the miracle comeback, with Liverpool scoring three goals in 6 minutes."},
...
// ════════════════════════════════════════════
// DIFFICULTY CONSTANTS  (declared ONCE globally)
// ════════════════════════════════════════════
const DIFF_BY_RANK = {
  'Bronze':   ['easy'],
  'Silver':   ['easy', 'medium'],
...
const DXPM = {
  easy: 8, medium: 12, hard: 16, very_hard: 20, impossible: 26, legend: 35,
};

const DLABEL = {
  easy: '⚽ Easy', medium: '🎯 Medium', hard: '🔥 Hard',
  very_hard: '💀 Very Hard', impossible: '☠️ Impossible', legend: '👑 LEGEND',
};

const DCLASS = {
  easy: 'diff-easy', medium: 'diff-medium', hard: 'diff-hard',
  very_hard: 'diff-hard', impossible: 'diff-impossible', legend: 'diff-impossible',
};
...
// ════════════════════════════════════════════
// CAREER PATH DATA — 10 FOOTBALLERS
// ════════════════════════════════════════════
const CAREER_PATHS = {
  'pele': {
    phases:[
      ...
      {name:'Professional',diff:'pro',questions:[
        ...
        {q:"Against which club did Pelé score his 1,000th career goal?",opts:["Argentina","Uruguay","Vasco da Gama (club)","Paraguay"],ans:2,fact:"Pelé scored his 1,000th career goal against Vasco da Gama from the penalty spot in 1969."},
      ]},
  ...
  'ronaldo_cr7': {
    phases:[
      ...
      {name:'Professional',diff:'pro',questions:[
        ...
        {q:"How many La Liga titles did Ronaldo win with Real Madrid?",opts:["2","3","4","5"],ans:0,fact:"Ronaldo won 2 La Liga titles with Real Madrid in 2012 and 2017."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
  ...
  'zidane': {
    phases:[
      {name:'Early Life',diff:'beginner',questions:[
        {q:"In which French city was Zinedine Zidane born?",opts:["Paris","Lyon","Marseille","Nice"],ans:2,fact:"Zidane was born in Marseille in 1972 to Algerian immigrant parents from Kabylie."},
        {q:"What is Zidane's nickname?",opts:["Zizou","El Maestro","The Emperor","La Pulga"],ans:0,fact:"Zidane is universally known as 'Zizou' — a childhood nickname that stuck throughout his career."},
        {q:"Which club did Zidane start his professional career with?",opts:["PSG","Lyon","Bordeaux","Cannes"],ans:3,fact:"Zidane began his professional career at AS Cannes in 1989 before moving to Bordeaux."},
      ]},
      {name:'Youth Career',diff:'youth',questions:[
        {q:"Which club did Zidane join after Bordeaux that made him a global star?",opts:["Real Madrid","AC Milan","Juventus","Barcelona"],ans:2,fact:"Zidane joined Juventus from Bordeaux in 1996, winning two Serie A titles and reaching two UCL finals."},
        {q:"How much did Real Madrid pay for Zidane in 2001?",opts:["€56m","€66m","€77.5m","€90m"],ans:2,fact:"Zidane joined Real Madrid for a then-world record fee of €77.5 million in 2001."},
      ]},
      {name:'Professional',diff:'pro',questions:[
        {q:"How many goals did Zidane score in the 1998 World Cup final?",opts:["1","2","3","4"],ans:1,fact:"Zidane scored twice with headers in the 1998 World Cup final against Brazil to win the trophy for France."},
        {q:"Which trophy did Zidane win in his very first Real Madrid season?",opts:["La Liga","Champions League","Copa del Rey","UEFA Super Cup"],ans:1,fact:"Zidane won the Champions League in his debut Real Madrid season in 2001-02."},
        {q:"How many Ballon d'Or awards did Zidane win?",opts:["1","2","3","4"],ans:2,fact:"Zidane won the Ballon d'Or three times: 1998, 2000, and 2003."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
        {q:"Against which country did Zidane headbutt Materazzi in the 2006 World Cup final?",opts:["Brazil","Germany","Portugal","Italy"],ans:3,fact:"Zidane headbutted Italian defender Marco Materazzi in extra time of the 2006 World Cup final — his last ever act in football."},
        {q:"What individual award did Zidane win at the 2006 World Cup despite his sending off?",opts:["Golden Boot","Golden Ball","Golden Glove","Silver Boot"],ans:1,fact:"Zidane won the Golden Ball as the tournament's best player at the 2006 World Cup, even despite his red card in the final."},
      ]},
      {name:'Legacy',diff:'legend',questions:[
        {q:"How many consecutive Champions League titles did Zidane win as Real Madrid manager?",opts:["2","3","4","5"],ans:1,fact:"Zidane won three consecutive Champions League titles as Real Madrid manager (2016, 2017, 2018)."},
        {q:"Zidane's famous 'Zidane-Volley' goal in the 2002 UCL final was against which club?",opts:["Barcelona","Bayern Munich","Manchester United","Bayer Leverkusen"],ans:3,fact:"Zidane's stunning left-footed volley against Bayer Leverkusen in the 2002 UCL final is often voted the greatest UCL goal ever."},
        {q:"In which year did Zidane resign as Real Madrid manager for the first time?",opts:["2017","2018","2019","2020"],ans:1,fact:"Zidane resigned from Real Madrid in June 2018 after winning his third consecutive Champions League, saying the team needed a new challenge."},
      ]},
    ]
  },
  'henry': {
    phases:[
      {name:'Early Life',diff:'beginner',questions:[
        {q:"In which French suburb was Thierry Henry born in 1977?",opts:["Saint-Denis","Les Ulis","Créteil","Banlieue"],ans:1,fact:"Henry was born in Les Ulis, a Paris suburb, on 17 August 1977."},
        {q:"Which club did Henry join as a teenager, starting his professional career?",opts:["PSG","Lyon","AS Monaco","Marseille"],ans:2,fact:"Henry joined AS Monaco's academy and made his professional debut for them in 1994."},
        {q:"At Monaco, who was Henry's famous youth manager who helped develop him?",opts:["Arsène Wenger","Didier Deschamps","Luis Fernández","Jean Tigana"],ans:0,fact:"A young Arsène Wenger managed Henry at Monaco before they were later reunited at Arsenal."},
      ]},
      {name:'Youth Career',diff:'youth',questions:[
        {q:"To which club did Henry move in 1999 before joining Arsenal?",opts:["Inter Milan","AC Milan","Juventus","Roma"],ans:2,fact:"Henry joined Juventus in 1999 but had an unhappy stint playing on the wing before Arsenal rescued him."},
        {q:"Arsène Wenger converted Henry from which position to striker at Arsenal?",opts:["Right back","Central midfielder","Left winger","Defensive midfielder"],ans:2,fact:"Henry was a winger at Juventus but Wenger converted him to a central/left striker — transforming his career."},
      ]},
      {name:'Professional',diff:'pro',questions:[
        {q:"How many goals did Henry score for Arsenal in his career?",opts:["174","228","243","261"],ans:1,fact:"Henry scored 228 goals in all competitions for Arsenal — the club's all-time top scorer."},
        {q:"How many Premier League Golden Boot awards did Henry win?",opts:["2","3","4","5"],ans:2,fact:"Henry won the Premier League Golden Boot four times (2002, 2004, 2005, 2006)."},
        {q:"Who was Henry's strike partner during Arsenal's Invincibles season?",opts:["Freddie Ljungberg","José Antonio Reyes","Dennis Bergkamp","Sylvain Wiltord"],ans:2,fact:"Henry and Dennis Bergkamp formed one of the most celebrated strike partnerships in Premier League history."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
        {q:"In which year did Henry join Barcelona?",opts:["2005","2006","2007","2008"],ans:2,fact:"Henry joined FC Barcelona in 2007, winning La Liga and the Champions League under Pep Guardiola."},
        {q:"Henry's infamous handball against Republic of Ireland was in a qualifier for which World Cup?",opts:["2006 Germany","2010 South Africa","2014 Brazil","2018 Russia"],ans:1,fact:"Henry's handball in November 2009 helped France qualify for the 2010 World Cup, sparking international outrage."},
      ]},
      {name:'Legacy',diff:'legend',questions:[
        {q:"Which MLS club did Henry play for after Barcelona?",opts:["LA Galaxy","New York Red Bulls","Toronto FC","Seattle Sounders"],ans:1,fact:"Henry played for New York Red Bulls from 2010 to 2014, becoming an MLS icon."},
        {q:"Which national team did Henry manage in 2019?",opts:["France","Ivory Coast","Canada","Belgium"],ans:2,fact:"Henry was appointed Canada men's national team manager in October 2019."},
        {q:"What is the name of the statue outside Emirates Stadium commemorating Henry?",opts:["The King","Le Maestro","The Non-Flying Frenchman","Thierry Henry Eternal"],ans:0,fact:"A statue titled 'The King' was unveiled outside Arsenal's Emirates Stadium in Henry's honour in 2011."},
      ]},
    ]
  },
  'ronaldo_r9': {
    phases:[
      {name:'Early Life',diff:'beginner',questions:[
        {q:"In which Brazilian city was Ronaldo R9 born?",opts:["São Paulo","Brasília","Belo Horizonte","Rio de Janeiro"],ans:3,fact:"Ronaldo Luís Nazário de Lima was born in Itaguaí, a suburb of Rio de Janeiro, on 22 September 1976."},
        {q:"What is Ronaldo R9's full birth name?",opts:["Ronaldo Carlos de Lima","Ronaldo Luís Nazário de Lima","Ronaldo José Santos","Ronaldo Bezerra Lima"],ans:1,fact:"His full name is Ronaldo Luís Nazário de Lima — simply 'Ronaldo' to the football world."},
        {q:"Which Brazilian club did Ronaldo start his career at?",opts:["Santos","Flamengo","Cruzeiro","Sport Recife"],ans:2,fact:"Ronaldo began his professional career at Cruzeiro, scoring 44 goals in 47 matches before moving to Europe."},
      ]},
      {name:'Youth Career',diff:'youth',questions:[
        {q:"To which Dutch club did Ronaldo move aged 17 in 1994?",opts:["Ajax","Feyenoord","PSV Eindhoven","AZ Alkmaar"],ans:2,fact:"Ronaldo joined PSV Eindhoven for just £4 million, scoring 54 goals in 57 appearances."},
        {q:"How much did Barcelona pay for Ronaldo in 1996?",opts:["£13.5m","£17m","£20m","£25m"],ans:0,fact:"Barcelona paid £13.5 million for Ronaldo in 1996 — he scored 47 goals in 49 matches in one season."},
      ]},
      {name:'Professional',diff:'pro',questions:[
        {q:"To which club did Ronaldo move from Barcelona in 1997?",opts:["Real Madrid","Juventus","Inter Milan","AC Milan"],ans:2,fact:"Ronaldo joined Inter Milan for a world record £19.5 million in 1997, winning the UEFA Cup in his first season."},
        {q:"How many games in a row did Ronaldo miss at Inter due to his mysterious seizure incident?",opts:["12","18","20","Over 24"],ans:3,fact:"Ronaldo suffered a mysterious seizure before the 1998 World Cup final and missed over two years of football with Inter due to successive knee injuries."},
        {q:"Which World Cup did Ronaldo top score in with 8 goals?",opts:["1998","2002","2006","1994"],ans:1,fact:"Ronaldo was the 2002 World Cup top scorer with 8 goals, winning the Golden Boot and leading Brazil to victory."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
        {q:"How many World Cup goals did Ronaldo score in his career in total?",opts:["12","14","15","17"],ans:1,fact:"Ronaldo scored 15 World Cup goals across four tournaments (1994, 1998, 2002, 2006) — the record at the time."},
        {q:"For which club did Ronaldo score a hat-trick on his debut?",opts:["AC Milan","Real Madrid","Corinthians","Inter Milan"],ans:1,fact:"Ronaldo scored a hat-trick on his Real Madrid debut against Deportivo La Coruña in 2002."},
      ]},
      {name:'Legacy',diff:'legend',questions:[
        {q:"Which Brazilian club did Ronaldo return to at the end of his career in 2009?",opts:["Santos","Flamengo","Corinthians","Vasco da Gama"],ans:2,fact:"Ronaldo joined Corinthians in 2009, helping the club win the Brazilian championship."},
        {q:"How many Ballon d'Or awards did Ronaldo R9 win?",opts:["1","2","3","4"],ans:1,fact:"Ronaldo won the Ballon d'Or twice — in 1997 and 2002."},
        {q:"Ronaldo R9 is part owner of which Spanish football club?",opts:["Real Valladolid","Athletic Bilbao","Deportivo La Coruña","Celta Vigo"],ans:0,fact:"Ronaldo purchased a majority stake in Real Valladolid in 2018 and later sold the club in 2023."},
      ]},
    ]
  },
  'maldini': {
    phases:[
      {name:'Early Life',diff:'beginner',questions:[
        {q:"In which Italian city was Paolo Maldini born?",opts:["Turin","Rome","Naples","Milan"],ans:3,fact:"Maldini was born in Milan on 26 June 1968 — he truly is a Milan-born AC Milan legend."},
        {q:"What position did Maldini play?",opts:["Centre-back","Right-back","Left-back","Sweeper"],ans:2,fact:"Maldini was a left-back who is universally regarded as the greatest defensive player of all time."},
        {q:"Which legendary AC Milan manager gave Maldini his debut at age 16?",opts:["Fabio Capello","Arrigo Sacchi","Nils Liedholm","Giovanni Trapattoni"],ans:2,fact:"Nils Liedholm gave the 16-year-old Maldini his Serie A debut on 20 January 1985."},
      ]},
      {name:'Youth Career',diff:'youth',questions:[
        {q:"At how many years old did Maldini make his full Italy debut?",opts:["17","18","19","20"],ans:2,fact:"Maldini made his full international debut for Italy at just 19 years old in 1988."},
        {q:"How many consecutive seasons did Maldini play for AC Milan in Serie A?",opts:["18","20","23","25"],ans:3,fact:"Maldini played 25 consecutive seasons in Serie A for AC Milan — entirely at one club."},
      ]},
      {name:'Professional',diff:'pro',questions:[
        {q:"How many Serie A titles did Maldini win with AC Milan?",opts:["5","6","7","8"],ans:2,fact:"Maldini won 7 Serie A titles with AC Milan across his remarkable career."},
        {q:"How many times did Maldini win the Champions League?",opts:["3","4","5","6"],ans:2,fact:"Maldini won the Champions League an extraordinary 5 times (1989, 1990, 1994, 2003, 2007)."},
        {q:"What shirt number was Maldini famous for wearing at AC Milan?",opts:["3","5","6","13"],ans:0,fact:"Maldini wore the #3 shirt throughout his career at AC Milan. The number was retired upon his departure."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
        {q:"Which year did Maldini captain Italy to the World Cup final?",opts:["1990","1994","1998","2002"],ans:1,fact:"Maldini captained Italy to the 1994 World Cup final, which they lost to Brazil on penalties."},
        {q:"Maldini was part of an AC Milan defence that included which legendary sweeper?",opts:["Baresi","Costacurta","Nesta","All three at different times"],ans:3,fact:"Maldini played alongside Franco Baresi, Alessandro Costacurta, and later Alessandro Nesta in successive great Milan defences."},
      ]},
      {name:'Legacy',diff:'legend',questions:[
        {q:"In what year did Maldini finally retire from professional football?",opts:["2007","2008","2009","2010"],ans:2,fact:"Maldini retired in May 2009 at age 40, having made 902 appearances for AC Milan."},
        {q:"How many times did Maldini play for Italy?",opts:["103","111","126","138"],ans:2,fact:"Maldini made 126 appearances for Italy — the most by any Italian player at the time."},
        {q:"When did Maldini return to AC Milan in a sporting director role?",opts:["2015","2016","2018","2020"],ans:2,fact:"Maldini was appointed AC Milan Technical Director in 2018, helping rebuild the club back to Italian and European prominence."},
      ]},
    ]
  },
  'guardiola': {
    phases:[
      {name:'Early Life',diff:'beginner',questions:[
        {q:"In which Spanish town was Pep Guardiola born?",opts:["Barcelona","Santpedor","Girona","Manresa"],ans:1,fact:"Guardiola was born in Santpedor, a small town in Catalonia, on 18 January 1971."},
        {q:"As a player, which club did Guardiola spend most of his career at?",opts:["Real Madrid","Deportivo","Valencia","Barcelona"],ans:3,fact:"Guardiola spent 11 years as a player at Barcelona (1990-2001), becoming a Club icon."},
        {q:"What playing position did Guardiola occupy?",opts:["Left winger","Defensive midfielder","Centre-back","Right-back"],ans:1,fact:"Guardiola was a deep-lying playmaker or holding midfielder — the organising brain of the team."},
      ]},
      {name:'Youth Career',diff:'youth',questions:[
        {q:"Who was Guardiola's iconic manager who shaped his philosophy as a player?",opts:["Louis van Gaal","Robson","Johan Cruyff","Bobby Robson"],ans:2,fact:"Johan Cruyff was Guardiola's manager at Barcelona, instilling the principles of Total Football that Guardiola later made famous."},
        {q:"Which major trophy did Guardiola win as a player at the 1992 Olympics?",opts:["Gold Medal","Silver Medal","Bronze Medal","Did not compete"],ans:0,fact:"Guardiola won a gold medal with Spain at the 1992 Barcelona Olympics — in front of their home crowd."},
      ]},
      {name:'Professional',diff:'pro',questions:[
        {q:"Which team did Guardiola manage before taking over Barcelona's first team?",opts:["Girona","Barcelona B","Espanyol","Villarreal"],ans:1,fact:"Guardiola managed Barcelona B (the reserve team) in 2007-08, winning promotion before being promoted to the first team."},
        {q:"How many trophies did Guardiola win in his first season as Barcelona manager?",opts:["3","4","5","6"],ans:3,fact:"Guardiola won an unprecedented 6 trophies in his first season at Barcelona in 2008-09."},
        {q:"How many Champions League titles did Guardiola win as a manager as of 2024?",opts:["1","2","3","4"],ans:2,fact:"Guardiola has won the Champions League three times as a manager — twice with Barcelona (2009, 2011) and once with Manchester City (2023)."},
      ]},
      {name:'Peak / Prime',diff:'prime',questions:[
        {q:"With which club did Guardiola win his first Bundesliga title?",opts:["Borussia Dortmund","Bayer Leverkusen","Bayern Munich","Leipzig"],ans:2,fact:"Guardiola managed Bayern Munich from 2013 to 2016, winning three consecutive Bundesliga titles."},
        {q:"In which year did Guardiola join Manchester City?",opts:["2015","2016","2017","2018"],ans:1,fact:"Guardiola joined Manchester City in July 2016, replacing Manuel Pellegrini."},
      ]},
      {name:'Legacy',diff:'legend',questions:[
        {q:"How many Premier League titles has Guardiola won with Manchester City as of 2024?",opts:["4","5","6","7"],ans:2,fact:"Guardiola has won 6 Premier League titles with Manchester City (2018, 2019, 2021, 2022, 2023, 2024)."},
        {q:"What tactical concept is most associated with Guardiola's management style?",opts:["Gegenpressing","Total Football","Juego de Posición","Catenaccio"],ans:2,fact:"Guardiola is famous for 'Juego de Posición' (positional play) — where players occupy specific zones to control space and the game."},
        {q:"Which city does Guardiola have Spanish citizenship with, alongside Catalan?",opts:["Madrid","Seville","Spain (national)","He only holds Catalan citizenship"],ans:2,fact:"Guardiola holds Spanish (and Catalan) citizenship, though he has been a vocal supporter of Catalan independence."},
      ]},
    ]
  },
};
...
function startRanked(){
  // Use rank-appropriate questions via getRankedQuestions()
  rQ = getRankedQuestions();
...
function fillRQ(q){
  ...
  document.getElementById('diff-tag').className='diff-tag '+(DCLASS[diff]||'diff-easy');
  document.getElementById('diff-tag').textContent=DLABEL[diff]||diff;
